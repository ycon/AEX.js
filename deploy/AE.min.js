...
h),p.transfer(b).lerp(c,h),l.transfer(y).lerp(p,h),b=p.lerp(q,h),k.transfer(l).lerp(b,h),O(a,y,l.clone(),k.clone(),e,f));g=k.clone().lerp(b,1.5);j=d.clone().lerp(q,1.5);e.curveTo(g.lerp(j,0.5),d.clone())}return e},P=function(a){if(!(a instanceof this._type))throw"not the right type";},w=function(a){this._items=[];this._type=Object;if(a&&a.prototype instanceof this._type)this._type=a;this.on={add:new M.Signal,remove:new M.Signal,swap:new M.Signal}};w.prototype={constructor:w,_items:null,_type:null,
index:function(a){return this._items.indexOf(a)},have:function(a){return-1!==this.index(a)},get:function(a){return this._items[a]},getLength:function(){return this._items.length},add:function(a){P.call(this,a);if(this.have(a))throw"item already present";this._items.push(a);this.on.add.dispatch(a,this.length-1,this)},insert:function(a,b){P.call(this,a);var c=this._items;if(this.have(a))throw"item already present";b<c.length?c.splice(b,0,a):c.push(a);c=Math.max(b,this.length-1);this.on.add.dispatch(a,
c,this)},remove:function(a){var b=this._items,c=b.indexOf(a);if(-1!==c)b.splice(c,1),this.on.remove.dispatch(a,c,this);else throw"item not present";},swap:function(a,b){var c=this._items,d=c.indexOf(a),e=c.indexOf(b);if(-1!==d&&-1!==e)c[d]=b,c[e]=a,this.on.swap.dispatch(d,e,this);else throw"one of the items not present";},each:function(a){for(var b=this._items,c=b.length,d=0;d<c;d++)a(b[d])}};k.Stack=w;var H=function(a,b,c,d,e){this.p1x=a;this.p1y=b;this.p2x=c;this.p2y=d;this.cx=3*a;this.bx=3*(c-
...
D.prototype={constructor:D,length:function(){if(this.update){var a=this.offset,b=this.keys_.length,c;this.update=!1;this.lengths_=[a];for(c=1;c<b;c++)a+=this.keys_[c].length,this.lengths_.push(a);this.lastPos_=this.offset;this.lastItemPos_=0;this.length_=a}return this.length_},get:function(a){var b=this.length(),c=this.keys_.length,d;if(a<this.offset||a>=b)return this.keys_[c-1].get(1);for(var e=a>=this.lastPos_?1:-1,f=this.lastItemPos_;f<c;f+=e)if(b=this.lengths_[f],d=this.keys_[f],a>=b&&a<b+d.length)return this.lastItemPos_=
f,this.lastPos_=b,d.get(a-b)},set:function(a){a=this.get(a);if(a!==this.obj_[this.prop_]&&(this.obj_[this.prop_]=a,!1!==this.obj_.update))this.obj_.update=!0},addLinear:function(a,b){var c=new L(this.lastItem_,a,b);this.keys_.push(c);this.lastItem_=c;this.update=!0},addBezier:function(a,b,c,d,e,f){a=new L(this.lastItem_,a,b,c,d,e,f);this.keys_.push(a);this.lastItem_=a;this.update=!0},addHold:function(a,b){var c=new L(null,a,b);this.keys_.push(c);this.lastItem_=c;this.update=!0}};k.Keys=D;var s=function(a,
b,c,d){D.call(this,a,b,c,d);if(d)this.lastItem_={path:{end:d}}};s.prototype=new D;s.prototype.constructor=s;s.prototype.set=function(a){a=this.get(a);if(!this.obj_.equals(a)&&(this.obj_.transfer(a),!1!==this.prop_.update))this.prop_.update=!0};s.prototype.addLinear=function(a,b,c,d){var e=this.lastItem_.path.end,a=!b&&!c||a.equals(c)&&e.equals(b)?new z(e,a):new A(e,b,c,a),d=new N(a,d);this.keys_.push(d);this.lastItem_=d;this.update=!0};s.prototype.addBezier=function(a,b,c,d,e,f,g,j){var h=this.lastItem_.path.end,
a=!b&&!c||a.equals(c)&&h.equals(b)?new z(h,a):new A(h,b,c,a),d=new N(a,d,e,f,g,j);this.keys_.push(d);this.lastItem_=d;this.update=!0};s.prototype.addHold=function(a,b){var c=new Q(a,b);this.keys_.push(c);this.lastItem_=c;this.update=!0};k.SpatialKeys=s;var t=function(){this.is3D=!0;this.parent=null;this.visible=!0};t.prototype.getMatrix=function(){if(!this.is3D)return this.getMatrix2D();var a=this.getLocalMatrix(),b=this.parent;b&&a.multiply(b.getMatrix());return a};t.prototype.getMatrix2D=function(){var a=
this.getLocalMatrix2D(),b=this.parent;b&&a.multiply(b.getMatrix2D());return a};t.prototype.getLocalMatrix=function(){return new m};t.prototype.getLocalMatrix2D=function(){return new m};var o=function(){t.call(this);this.filters=new w;this.masks=new w;this.collapse=!1;this.position=new n;this.anchor=new n;this.scale=new n(1,1,1);this.rotation=new n;this.orientation=new n;this.opacity=1};o.prototype=new t;o.prototype.constructor=o;o.prototype.getLocalMatrix=function(){var a=this.position,b=this.anchor,
c=this.scale,d=this.rotation,e=this.orientation;return(new m).translation(-b.x,-b.y,-b.z).scale(c.x,c.y,c.z).rotate(d.x,d.y,d.z).rotate(e.x,e.y,e.z).translate(a.x,a.y,-a.z)};o.prototype.getLocalMatrix2D=function(){var a=this.position,b=this.anchor,c=this.scale;return(new m).translation(-b.x,-b.y,0).scale(c.x,c.y,1).rotate(0,0,this.rotation.z).translate(a.x,a.y,0)};k.Layer=o;var u=function(){t.call(this);this.position=new n;this.rotation=new n;this.target=new n;this.haveTarget=!0;this.zoom=1333.33;
this.center=new n;this.is3D=!0};u.prototype=new t;u.prototype.constructor=u;u.prototype.getLocalMatrix=function(){var a=this.rotation,b=this.target,c=this.position,a=(new m).rotate(a.x,a.y,a.z);this.haveTarget&&a.lookAt(b.x-c.x,b.y-c.y,b.z-c.z);a.translate(c.x,c.y,-c.z);return a};u.prototype.getLocalMatrix2D=function(){return(new m).rotate(0,0,this.rotation.z).translate(this.position.x,this.position.y,0)};u.prototype.getCameraMatrix=function(){var a=this.center;return(new m).translate(a.x,a.y,this.zoom).preMultiply(this.getMatrix().createInvert())};
k.Camera=u;var E=function(){o.call(this);this.color="#000000";this.width=640;this.height=360};E.prototype=new o;E.prototype.constructor=E;k.Solid=E;var B=function(){o.call(this);this.layers=new w(o);this.cameras=new w(u);this.width=640;this.height=360};B.prototype=new o;B.prototype.constructor=B;B.prototype.getCamera=function(){var a=0,b=this.cameras.length,c=null,d=null,a=0;a:for(;a<b;a++)if(c=this.cameras.get(a),c.visible){d=c;break a}return d};k.Composition=B;var F=function(){o.call(this);this.text=
"";this.textArea=new I(0,0,150,150);this.textClass=null;this.fontFamily="Arial";this.textColor="#888888";this.fontSize=18;this.lineHeight=1.2;this.letterSpacing=0;this.textAlign="left";this.verticalAlign="top";this.collapse=!0};F.prototype=new o;F.prototype.constructor=F;k.Text=F;var r=function(a){this.model=a;this.element=this.holder=document.createElement(this.tagName);this.prevScale=0;this.visible=!1};r.prototype={constructor:r,tagName:"layer",visible:!1,setVisible:function(a){if(a!==this.visible)this.visible=
...
d.style.WebkitTransform,c.appendChild(d)}else{if(c.parentElement)c.parentElement.replaceChild(d,c),d.style.WebkitTransform=c.style.WebkitTransform;this.element=d}if(e.collapse){var e=1,e=a.m21,f=a.m22,g=a.m23,c=this.prevScale,e=Math.sqrt(e*e+f*f+g*g)*(b/(b-a.m43));if(1.5<e/c||0.75>e/c)this.prevScale=e,d.style.WebkitTransform="scale("+e+","+e+")";d=1/e;a.preMultiply((new m).scaling(d,d,1))}else this.prevScale=0;return a},modifyMatrix:function(a){return a}};var x=function(a){r.call(this,a)};x.prototype=
new r(null);x.prototype.constructor=x;x.prototype.tagName="solid";x.prototype.render=function(a,b){r.prototype.render.call(this,a,b);var c=this.holder,d=this.model;c.style.width=d.width;c.style.height=d.height;c.style.backgroundColor=d.color};var C=function(a){this.text=a;r.call(this,a);this.oldText={text:null,textArea:null,textClass:null,fontFamily:null,textColor:null,fontSize:null,lineHeight:null,letterSpacing:null,textAlign:null,verticalAlign:null}};C.prototype=new r(null);C.prototype.constructor=
