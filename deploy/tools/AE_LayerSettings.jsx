 ...
 * Version: 0.1.1 - Build: 18036 (2012/04/30 08:11 AM)
 */
...
var getGaussLength = function(min, max, c1, c2) {
	...
	var mult = 0.5 * (max - min), ab2 = 0.5 * (min + max), vec = c2.clone();
...
/**
 * cubicToQuadratic Will divide a cubic curve into a set of quadratic curves.
